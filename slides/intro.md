...
But getting any more information is difficult. According to the [8 Principles of Open Data](http://opengovdata.org), a measure developed by open government advocates to create a set of universal data principles, Cook County courts, and the Cook County Clerk of the Circuit Court who maintain the court's data and makes it only minimal available online, only meets half of the requirements.
